...
3. Build the project ("AspNetCoreSpreadsheetEditorDemo.Net10.csproj" file) in Visual Studio or using .NET CLI:
   ```
   dotnet build AspNetCoreSpreadsheetEditorDemo.Net10.csproj
   ```
